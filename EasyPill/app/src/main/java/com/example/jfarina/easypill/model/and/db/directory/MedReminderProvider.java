...
public class MedReminderProvider extends ContentProvider {
    ...
    public static final String LOG_TAG = MedReminderContract.class.getSimpleName();
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case REMINDER:
                cursor = database.query(MedReminderContract.MedReminderEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case REMINDER_ID:
                selection = MedReminderContract.MedReminderEntry._ID + "=?";
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            case REMINDER:
                return MedReminderContract.MedReminderEntry.CONTENT_LIST_TYPE;
            case REMINDER_ID:
                return MedReminderContract.MedReminderEntry.CONTENT_ITEM_TYPE;
            default:
    ...
    private Uri insertReminder(Uri uri, ContentValues values) {
        ...
        long id = database.insert(MedReminderContract.MedReminderEntry.TABLE_NAME, null, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case REMINDER:
                rowsDeleted = database.delete(MedReminderContract.MedReminderEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case REMINDER_ID:
                selection = MedReminderContract.MedReminderEntry._ID + "=?";
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };
    ...
    private int updateReminder(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(MedReminderContract.MedReminderEntry.TABLE_NAME, values, selection, selectionArgs);
